...
export const Login = () => {
  ...
  const handlePasswordReset = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: t('Guuleysatay!', 'Success!'),
        description: t('Link-ka password cusub waa loo diray email-kaaga', 'Password reset link sent to your email')
      });
          ...
          {!showResetForm ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    >
                      {t('Ma ilowday sirta?', 'Forgot password?')}
                    </Button>
                  </div>
                  <div className="relative">
            ...
            <>
              <form onSubmit={handlePasswordReset} className="space-y-4">
                <div>
                  <Label htmlFor="resetEmail">{t('Email', 'Email')}</Label>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder={t('Gali email-kaaga si aad u hesho link cusub', 'Enter your email to get reset link')}
                      className="pl-10"
                      required
                    />
                  </div>
                ...
                <Button type="submit" className="w-full" disabled={resetLoading}>
                  {resetLoading ? t('Sugaya...', 'Loading...') : t('Dir Link-ka Password Cusub', 'Send Reset Link')}
                </Button>
              </form>
              ...
              <div className="text-center mt-4">
                ...
                >
                  {t('Ku noqo login-ka', 'Back to login')}
                </Button>
              </div>
            </>
          )}
